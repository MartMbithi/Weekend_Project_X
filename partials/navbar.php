        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="houses" class="nav-link">My House</a>
                    </li>
                    <li class="nav-item">
                        <a href="payments" class="nav-link">My Payments</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">
                            My Reports
                        ...
                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                            <li><a href="reports_payments" class="dropdown-item">Invoices</a></li>
                            <li><a href="reports_expenses" class="dropdown-item">My Payments</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
