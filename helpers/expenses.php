...
if (isset($_POST['Update_Expense'])) {
    ...
    /* Persist */
    $update_sql = "UPDATE expenses SET expense_user_id = '{$expense_user_id}', expense_type = '{$expense_type}', expense_amount = '{$expense_amount}', expense_date = '{$expense_date}' WHERE expense_id = '{$expense_id}'";
